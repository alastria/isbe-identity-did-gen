# ISBE-ART-00004 — ISBE DID Registry CLI
...
- **Interoperabilidad:** los datos generados siguen el estándar DID Core.
...
[CLI] 
   → Commander.js
       → didCommands / controllerCommands / relationshipCommands / verificationCommands
           → did-isbe-registry-dev
               → RPC Provider (ethers.js)
                   → Smart Contract ISBE DID Registry
...
|update-alias-onchain	|Actualiza campo alsoKnownAs en el contrato             |
...
- Los fragments se generan con un hash truncado en Base58.
...
- búsqueda inversa: obtener todos los DIDs que usan un VM en una relación específica
...
|src/commands/controller.ts	            |Controllers                        |
...
|Componente	                |Descripción                        |
----------------------------------------------------------------
|Código fuente	            |Implementación completa TypeScript |
...
- No almacena información personal salvo alias opcional
